...
# Copy the readthedocs.yml file from the template file
echo "Copying readthedocs.yml file"
cp /mnt/c/users/mangg/template_files/readthedocs.yml readthedocs.yml
echo "readthedocs.yml file copied successfully"
echo ""

# Copy the docs_requirements.txt file from the template file to the docs directory
echo "Copying docs_requirements.txt file to docs directory"
cp /mnt/c/users/mangg/template_files/docs_requirements.txt docs/requirements.txt
echo "docs_requirements.txt file copied successfully to docs directory"
echo ""
